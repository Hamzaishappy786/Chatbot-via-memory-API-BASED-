...
export const SparkIcon = (p) => (
  <svg {...base} {...p}><path d="M12 3l1.9 5.8a2 2 0 0 0 1.3 1.3L21 12l-5.8 1.9a2 2 0 0 0-1.3 1.3L12 21l-1.9-5.8a2 2 0 0 0-1.3-1.3L3 12l5.8-1.9a2 2 0 0 0 1.3-1.3z" /></svg>
);
export const DotIcon = (p) => (
  <svg {...base} {...p} width="10" height="10"><circle cx="12" cy="12" r="10" /></svg>
);
